...
const stringifyStudent = JSON.stringify(student, ['firstName', 'lastName', 'skills'])
console.log(stringifyStudent)

let txtObject = JSON.parse(txt)
console.log(txtObject)

txtObject = Object.entries(txtObject)
.sort( (a, b) => b[1].skills.length - a[1].skills.length)[0]

// .map( item => item[1].skills.length )
// .sort( (a , b) => b - a ) [0]
