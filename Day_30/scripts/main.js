...
const displayCountry = document.querySelector(".contents");
const total = document.querySelector(".totalCountry");
const searchQuery = document.querySelector(".searchDisplay");

console.log(countries);

const renderDisplay = () => {
  displayCountry.innerHTML = countries
    .map(
      ({ name, languages, flag, capital, population }) => ` 
        <div class="content">
...
search.addEventListener("click", (e) => {
  const { byName, byPopulation, byCapital, inputEl } = e.target;
});
